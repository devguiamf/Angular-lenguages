import { FRASES } from './../../linguas/alemao/frase-mock';
...
@Component({
  selector: 'app-alemao',
  templateUrl: './alemao.component.html',
  styleUrls: ['./alemao.component.scss']
})
export class AlemaoComponent implements OnInit {
